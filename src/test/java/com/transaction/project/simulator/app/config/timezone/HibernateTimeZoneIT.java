package com.transaction.project.simulator.app.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.transaction.project.simulator.app.IntegrationTest;
import com.transaction.project.simulator.app.repository.timezone.DateTimeWrapper;
import com.transaction.project.simulator.app.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM stp_date_time_wrapper where id=%d", fieldName, id);
    }
