...
/**
 * Criteria class for the {@link com.transaction.project.simulator.app.domain.Currency} entity. This class is used
 * in {@link com.transaction.project.simulator.app.web.rest.CurrencyResource} to receive all the possible filtering options from
...
public class CurrencyCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, accountBankId, distinct);
    }
