...
/**
 * Criteria class for the {@link com.transaction.project.simulator.app.domain.Issuer} entity. This class is used
 * in {@link com.transaction.project.simulator.app.web.rest.IssuerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /issuers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
...
public class IssuerCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, cardId, distinct);
    }
