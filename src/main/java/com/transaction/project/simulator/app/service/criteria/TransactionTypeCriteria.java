...
/**
 * Criteria class for the {@link com.transaction.project.simulator.app.domain.TransactionType} entity. This class is used
 * in {@link com.transaction.project.simulator.app.web.rest.TransactionTypeResource} to receive all the possible filtering options from
...
public class TransactionTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, transactionId, distinct);
    }
