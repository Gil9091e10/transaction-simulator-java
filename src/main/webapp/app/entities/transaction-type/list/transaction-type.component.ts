...
import { EntityArrayResponseType, TransactionTypeService } from '../service/transaction-type.service';
import { TransactionTypeDeleteDialogComponent } from '../delete/transaction-type-delete-dialog.component';

@Component({
  standalone: true,
  selector: 'stp-transaction-type',
...
export class TransactionTypeComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.transactionTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITransactionType[] | null): ITransactionType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.transactionTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
