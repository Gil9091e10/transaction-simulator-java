...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSACTIONTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSACTIONTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRANSACTIONTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSACTIONTYPE actions', async () => {
      const arg = 42666;
