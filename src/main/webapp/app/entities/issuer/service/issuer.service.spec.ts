...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../issuer.test-samples';

import { IssuerService } from './issuer.service';

const requireRestSample: IIssuer = {
...
describe('Issuer Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Issuer', () => {
      const issuer = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(issuer).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Issuer', () => {
      const issuer = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(issuer).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addIssuerToCollectionIfMissing', () => {
      it('should add a Issuer to an empty array', () => {
        const issuer: IIssuer = sampleWithRequiredData;
      ...
      it("should add a Issuer to an array that doesn't contain it", () => {
        const issuer: IIssuer = sampleWithRequiredData;
        const issuerCollection: IIssuer[] = [sampleWithPartialData];
        expectedResult = service.addIssuerToCollectionIfMissing(issuerCollection, issuer);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(issuer);
      });
      ...
      it('should add only unique Issuer to an array', () => {
        const issuerArray: IIssuer[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const issuerCollection: IIssuer[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const issuer: IIssuer = sampleWithRequiredData;
        const issuer2: IIssuer = sampleWithPartialData;
    ...
    describe('compareIssuer', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareIssuer(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareIssuer(entity1, entity2);
        const compareResult2 = service.compareIssuer(entity2, entity1);
