...
import { sampleWithRequiredData } from '../issuer.test-samples';
...
describe('Issuer Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.issuers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to issuerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIssuerIdentifier');
      const id = comp.trackId(entity);
      expect(service.getIssuerIdentifier).toHaveBeenCalledWith(entity);
