...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './issuer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISSUER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ISSUER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ISSUER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ISSUER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ISSUER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ISSUER actions', async () => {
      const arg = 42666;
