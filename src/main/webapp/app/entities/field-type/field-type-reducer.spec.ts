...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIELDTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIELDTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIELDTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIELDTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIELDTYPE actions', async () => {
      const arg = 42666;
