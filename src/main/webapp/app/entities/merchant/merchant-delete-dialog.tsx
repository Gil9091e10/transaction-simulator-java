...
export const MerchantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simulatorApp.merchant.delete.question">
        <Translate contentKey="simulatorApp.merchant.delete.question" interpolate={{ id: merchantEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="cfg-confirm-delete-merchant" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
