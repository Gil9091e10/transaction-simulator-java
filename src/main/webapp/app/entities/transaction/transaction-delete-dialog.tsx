...
export const TransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simulatorApp.transaction.delete.question">
        <Translate contentKey="simulatorApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="cfg-confirm-delete-transaction" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
