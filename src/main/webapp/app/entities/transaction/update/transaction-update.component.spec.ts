...
describe('Transaction Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call TransactionType query and add missing value', () => {
      ...
      const transactionType: ITransactionType = { id: 23912 };
      transaction.transactionType = transactionType;

      const transactionTypeCollection: ITransactionType[] = [{ id: 11928 }];
    ...
    it('Should update editForm', () => {
      const transaction: ITransaction = { id: 456 };
      const transactionType: ITransactionType = { id: 20755 };
      transaction.transactionType = transactionType;
