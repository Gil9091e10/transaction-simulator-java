...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './advice.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADVICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADVICE actions', async () => {
      const arg = 42666;
