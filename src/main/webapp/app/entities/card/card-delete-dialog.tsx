...
export const CardDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simulatorApp.card.delete.question">
        <Translate contentKey="simulatorApp.card.delete.question" interpolate={{ id: cardEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="cfg-confirm-delete-card" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
