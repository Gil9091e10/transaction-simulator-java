...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './card-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARDTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARDTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CARDTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CARDTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARDTYPE actions', async () => {
      const arg = 42666;
