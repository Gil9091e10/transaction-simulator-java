...
import { sampleWithRequiredData } from '../card-type.test-samples';
...
describe('CardType Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to cardTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCardTypeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCardTypeIdentifier).toHaveBeenCalledWith(entity);
