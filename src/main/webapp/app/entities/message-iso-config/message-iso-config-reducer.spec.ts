...
import reducer, {
  ...
  reset,
  updateEntity,
} from './message-iso-config.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGEISOCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGEISOCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGEISOCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MESSAGEISOCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGEISOCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGEISOCONFIG actions', async () => {
      const arg = 42666;
