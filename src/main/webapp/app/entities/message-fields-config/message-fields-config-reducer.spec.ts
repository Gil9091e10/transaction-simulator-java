...
import reducer, {
  ...
  reset,
  updateEntity,
} from './message-fields-config.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGEFIELDSCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGEFIELDSCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGEFIELDSCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MESSAGEFIELDSCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGEFIELDSCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGEFIELDSCONFIG actions', async () => {
      const arg = 42666;
