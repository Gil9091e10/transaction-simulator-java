...
@Component({
  standalone: true,
  templateUrl: './message-type-indicator-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class MessageTypeIndicatorDeleteDialogComponent {
  messageTypeIndicator?: IMessageTypeIndicator;
  ...
  confirmDelete(id: number): void {
    this.messageTypeIndicatorService.delete(id).subscribe(() => {
