...
import reducer, {
  ...
  reset,
  updateEntity,
} from './message-type-indicator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGETYPEINDICATOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGETYPEINDICATOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGETYPEINDICATOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MESSAGETYPEINDICATOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGETYPEINDICATOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGETYPEINDICATOR actions', async () => {
      const arg = 42666;
