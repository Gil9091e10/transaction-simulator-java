...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEBITCARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEBITCARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEBITCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEBITCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEBITCARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEBITCARD actions', async () => {
      const arg = 42666;
