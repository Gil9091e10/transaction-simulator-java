...
import reducer, {
  ...
  reset,
  updateEntity,
} from './message-field-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGEFIELDTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGEFIELDTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGEFIELDTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MESSAGEFIELDTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGEFIELDTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGEFIELDTYPE actions', async () => {
      const arg = 42666;
