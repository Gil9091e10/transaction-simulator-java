...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITCARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CREDITCARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CREDITCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CREDITCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CREDITCARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CREDITCARD actions', async () => {
      const arg = 42666;
