...
import { sampleWithRequiredData } from '../credit-card.test-samples';
...
describe('CreditCard Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to creditCardService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCreditCardIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCreditCardIdentifier).toHaveBeenCalledWith(entity);
