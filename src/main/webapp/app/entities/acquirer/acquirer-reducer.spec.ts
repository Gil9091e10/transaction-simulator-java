...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './acquirer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACQUIRER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACQUIRER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACQUIRER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACQUIRER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACQUIRER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACQUIRER actions', async () => {
      const arg = 42666;
