...
import { sampleWithRequiredData } from '../acquirer.test-samples';
...
describe('Acquirer Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.acquirers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to acquirerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAcquirerIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAcquirerIdentifier).toHaveBeenCalledWith(entity);
