...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTBANK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACCOUNTBANK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACCOUNTBANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACCOUNTBANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTBANK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACCOUNTBANK actions', async () => {
      const arg = 42666;
