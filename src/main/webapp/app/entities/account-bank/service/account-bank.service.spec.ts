...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../account-bank.test-samples';

import { AccountBankService } from './account-bank.service';

const requireRestSample: IAccountBank = {
...
describe('AccountBank Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a AccountBank', () => {
      const accountBank = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(accountBank).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a AccountBank', () => {
      const accountBank = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(accountBank).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addAccountBankToCollectionIfMissing', () => {
      it('should add a AccountBank to an empty array', () => {
        const accountBank: IAccountBank = sampleWithRequiredData;
      ...
      it("should add a AccountBank to an array that doesn't contain it", () => {
        const accountBank: IAccountBank = sampleWithRequiredData;
        const accountBankCollection: IAccountBank[] = [sampleWithPartialData];
        expectedResult = service.addAccountBankToCollectionIfMissing(accountBankCollection, accountBank);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(accountBank);
      });
      ...
      it('should add only unique AccountBank to an array', () => {
        const accountBankArray: IAccountBank[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const accountBankCollection: IAccountBank[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const accountBank: IAccountBank = sampleWithRequiredData;
        const accountBank2: IAccountBank = sampleWithPartialData;
    ...
    describe('compareAccountBank', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareAccountBank(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareAccountBank(entity1, entity2);
        const compareResult2 = service.compareAccountBank(entity2, entity1);
